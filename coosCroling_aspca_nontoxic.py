...
def croling(data, count_dict, processnum):
    ...
    driver.get(url=URL)
    ingredients = driver.find_elements('xpath', '//*[@id="content"]/div[2]/div/div/div/div/div[3]/div/div[2]/div')
    #ingredients = driver.find_element('xpath', '//*[@id="site-name"]/a')
    
    print(len(ingredients))
    ingredientcount = len(ingredients)
    try: 
        xpath = '//*[@id="content"]/div[2]/div/div/div/div/div[3]/div/div[2]/div'
...
#     count = 0
    ...
    df.to_csv("aspca_nontoxic_data.csv", header=None, index=None)
